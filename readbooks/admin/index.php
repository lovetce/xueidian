                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="index_v1.html" data-index="0">活动管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v2.html">订单管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v3.html">海报管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v4.html">自动回复</a>
                            </li>
                            <li>
                                <a href="index_v5.html" target="_blank">公众号管理</a>
                            </li>
                        </ul>
